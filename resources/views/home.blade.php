...
<div class="container bg-white p-4 rounded text-center">
    ...
    <div class="row my-3">
        <div class="col-md-6 col-12 my-1">
            <div class="d-flex justify-content-between align-items-center rounded border-start border-alert border-4 bg-body-tertiary py-3">
                <div class="d-flex flex-column px-2">
                    <div class="fs-6 text-alert">Notificações</div>
                    <div class="fs-6">
                        Você possui 3 contas perto do vencimento
                    </div>
                </div>
        ...
        <div class="col-md-6 col-12 my-1">
            <div class="d-flex justify-content-between align-items-center rounded border-start border-info border-4 bg-body-tertiary py-3">
                <div class="d-flex flex-column px-2">
                    <div class="fs-6 text-info">Informações</div>
                    <div class="fs-6">
                        Último Acesso: 18/09/2023 16:34:00
                    </div>
                </div>

...
<div class="rounded text-center p-3 bg-white shadow-lg">
    ...
    <form action="{{isset($receita) ? route('receitas.update', $receita['id_receita']) : route('receitas.store')}}" method="POST" style="width: 30rem;">
        @csrf
        @isset($receita)
            @method('put')
        @endisset
        <div class="input-group mb-3">
            ...
            <input type="text" name="empresa" class="form-control" placeholder="Nome da Empresa" value="{{isset($receita) ? $receita['empresa']: ''}}">
        </div>
        <div class="input-group mb-3">
